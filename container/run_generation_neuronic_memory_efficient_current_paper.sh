...
ls -l "${HOST_PROJECTS_DIR}/scripts/duffing_network_learning_MNIST_sde_memory_efficient_current_paper_setting.py" || { echo "Script not found!"; exit 1; }

# === Payload ===
PAYLOAD="python3 -u /physical-diffusion-models/scripts/duffing_network_learning_MNIST_sde_memory_efficient_current_paper_setting.py"
