...
ls -l "${HOST_PROJECTS_DIR}/scripts/duffing_network_learning_MNIST_sde_memory_efficient_analytic_end.py" || { echo "Script not found!"; exit 1; }
...
export JAX_PLATFORMS=cuda,cpu
PAYLOAD="python3 -u /physical-diffusion-models/scripts/duffing_network_learning_MNIST_sde_memory_efficient_analytic_end.py"
