...
current_date_unit_potential_subtracted = f"{current_date}_unit_potential_subtracted"
base_dir = os.path.join(here,"..","out", current_date_unit_potential_subtracted, "problems")
